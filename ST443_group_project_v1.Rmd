...
# Ensure `label` is the dependent variable in the formula
qda_model <- qda(label ~ ., data = RNAdata)

# Step 4: Evaluate the model
# Predict on the test set
qda_predictions <- predict(qda_model, test_data2[,-1])  # Exclude label column
```
