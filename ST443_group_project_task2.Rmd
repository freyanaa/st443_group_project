...
Now we specify the balanced accuracy metric, which is the average of sensitivity (recall for the positive class) and specificity (recall for the negative class). This metric is crucial for imbalanced datasets, providing a fair assessment of the model performance across both classes.
